...
%{__install} -m 0644 -D autocomplete/adr %{buildroot}%{_datarootdir}/bash-completion/completions/adr
...
%{_bindir}/adr
%{_datarootdir}/bash-completion/completions/adr
%doc %{_docdir}/adr-tools/

%changelog
* Wed Jul 29 2026 Mathias Muench <mathias-muench@users.noreply.github.com> - 3.0.0-8
- Install bash completion from autocomplete/adr

* Mon Dec 15 2025 Mathias Muench <mathias-muench@users.noreply.github.com> - 3.0.0-7
- rebuilt
